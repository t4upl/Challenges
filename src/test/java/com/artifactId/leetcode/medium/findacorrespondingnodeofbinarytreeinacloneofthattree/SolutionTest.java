...
public class SolutionTest {
  ...
  public void leet1() {
    ...
    int targetValue = 3;
    TreeNode original = NodeUtils.parseTreeNode(tree);
    TreeNode copy = NodeUtils.parseTreeNode(tree);
    TreeNode target = NodeUtils.findNodeWithValue(original, targetValue);
    TreeNode expected = NodeUtils.findNodeWithValue(copy, targetValue);
