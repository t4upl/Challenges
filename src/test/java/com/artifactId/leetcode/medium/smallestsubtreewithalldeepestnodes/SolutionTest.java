...
public class SolutionTest {
  ...
  @Test
  public void test1() {
    TreeNode root = TestUtils.parseTreeNode("[1,2,3,null, null, 4]");
  ...
  @Test
  public void test2() {
    TreeNode root = TestUtils.parseTreeNode("[1,2,3,null, null, 4, 5, 6, null, null, 7]");
  ...
  @Test
  public void leet1() {
    TreeNode root = TestUtils.parseTreeNode("[3,5,1,6,2,0,8,null,null,7,4]");
  ...
  @Test
  public void leet2() {
    TreeNode root = TestUtils.parseTreeNode("[1]");
  ...
  @Test
  public void leet3() {
    TreeNode root = TestUtils.parseTreeNode("[0,1,3,null,2]");
    TreeNode expected = root.left.right;
    TreeNode result = solution.subtreeWithAllDeepest(root);
    Assert.assertEquals(expected, result);
  }
